...
require 'slack-ruby-bot-server-slack/version'

Gem::Specification.new do |spec|
  spec.name          = 'slack-ruby-bot-server-slack'
  spec.version       = SlackRubyBotServer::Slack::VERSION
  ...
  spec.homepage      = 'https://github.com/slack-ruby/slack-ruby-bot-server-slack'
